...
kids.push(P("A ToxT-DNA complex was predicted with the AlphaFold3 server using the full-length ToxT sequence and the native El Tor ctxAB promoter duplex (36 bp, positions -76 to -41; transcribed and verified from Dittmer & Withey, 2012 -- see Supplementary Section S.13 for the sequence and its verification). The top-ranked model (of five) was analysed (confidence: pTM, interface ipTM); the fatty-acid-bound crystal (3GBG) was superposed onto the modelled ToxT (Ca) to place the native lipid, protein-DNA contacts were defined at 5 A, and interactions were additionally profiled with PLIP 3.0.1. Given the modest interface confidence of the model (ipTM 0.48), it is reported in the Supplementary Information as an exploratory structural check rather than a main-text result.", { justify: true }));
...
kids.push(P("An exploratory AlphaFold3 model of ToxT bound to the native El Tor ctxAB promoter is presented in the Supplementary Information (Section S.13) as a structural check on the known domain architecture, not as a main-text result.", { justify: true }));
