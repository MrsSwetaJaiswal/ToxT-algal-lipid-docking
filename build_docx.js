...
kids.push(P("A preliminary AlphaFold3 model of the ToxT-DNA complex is presented in the Supplementary Information (Section S.13, Figure S23) as an exploratory structural check: the DNA contacted the C-terminal helix-turn-helix domain, spatially separate from the N-terminal fatty-acid pocket, consistent with an allosteric rather than steric mechanism - but the protein-DNA interface confidence was low (ipTM 0.31), so this is not presented as an established result.", { justify: true }));
